four51.app.config(['$routeProvider', '$locationProvider', function($routeProvider, $locationProvider) {
	...
	$routeProvider.
        ...
        when('/campaigns', { templateUrl: 'partials/Messages/home.html', controller: 'HomeCtrl' }).
        when('/campaigns/:categoryInteropID', { templateUrl: 'partials/categoryView.html', controller: 'CategoryCtrl' }).
		...
		when('/campaigns/:categoryInteropID/:subCategoryInteropID/:productInteropID', {templateUrl: concatProductView, controller: 'ProductCtrl'}).
		when('/campaigns/:categoryInteropID/:productInteropID', {templateUrl: concatProductView, controller: 'ProductCtrl'}).
        when('/campaigns/projects/:productInteropID', {templateUrl: concatProductView, controller: 'ProductCtrl'}).
        when('/campaigns/projects/:productInteropID/:variantInteropID', {templateUrl: concatProductView, controller: 'ProductCtrl'}).
        when('/product/:productInteropID/:variantInteropID', {templateUrl: concatProductView, controller: 'ProductCtrl'}).
		when('/campaigns/projects/:productInteropID/:variantInteropID/edit', {templateUrl: concatSpecFormView, controller: 'SpecFormCtrl'}).
		...
		when('/contactus', { templateUrl: 'partials/Messages/contactus.html', controller: 'ContactCtrl' }).
		when('/privacypolicy', { templateUrl: 'partials/Messages/privacypolicy.html' }).
