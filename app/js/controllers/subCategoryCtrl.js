...
function ($rootScope, $routeParams, $sce, $scope, $451, Category, Product, Nav) {
	...
	$scope.clickProject = function()
	{
		$routeParams.categoryInteropID = $parent.currentCategory.InteropID;
		$routeParams.subCategoryInteropID = c.InteropID;
		/*Product.search($routeParams.subCategoryInteropID, null, null, function (products, count) {
			$scope.products = products[0];
			$routeParams.productInteropID = $scope.products;
